...
public class AuthorizationCheck implements Serializable {
  ...
  protected List<PermissionCheck> authCheckParameters = new ArrayList<PermissionCheck>();
  ...
  public List<PermissionCheck> getAuthCheckParameters() {
    return authCheckParameters;
  }

  public void setAuthCheckParameters(List<PermissionCheck> authCheckParameters) {
    this.authCheckParameters = authCheckParameters;
  }

  public void addAuthCheckParameter(PermissionCheck parameter) {
    authCheckParameters.add(parameter);
  }
